...
| Component | Role |
|-----------|------|
| **[n8n](https://n8n.io/)** | 32 active workflows (27 exported) — alert intake, session management, knowledge population, teacher-agent runner, server-side session-replay |
...
| **[Compiled Wiki](wiki/index.md)** | 72 articles from 7+ sources, daily recompilation |
...
| Holistic health check | [96%+](scripts/holistic-agentic-health.sh) — ~148 checks across 39 sections (functional + e2e + cross-site) |
