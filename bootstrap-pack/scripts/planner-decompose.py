...
def run_decomposition(feature_id: str, repo_cwd: str, feature_text: str) -> tuple[list[dict], str]:
    ...
    # TODO: implement real Claude invocation via SSH
    # claude -p "...prompt..." --output-format stream-json --verbose
    raise NotImplementedError(
        "No pre-decomposed tasks.json found and real Claude decomposition not yet implemented. "
        "Use --dry-run for synthetic test, or write a tasks.json via the bootstrap-pack /tasks skill."
    )
