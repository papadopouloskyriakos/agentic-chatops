...
STATE_DIR="/home/claude-runner/scripts/watchdog-state"
N8N_URL="https://n8n.example.net"
N8N_API_KEY=$(jq -r '.mcpServers["n8n-mcp"].env.N8N_API_KEY' /home/claude-runner/.claude.json 2>/dev/null || echo "")
...
declare -A WORKFLOWS=(
  ...
  [claude-runner]="qadF2WcaBsIR7SWG"
...
check_stale_locks() {
  local gw_dir="/home/claude-runner/gitlab/products/cubeos/claude-context"
  local now
  now=$(date +%s)
