...
# Intersite exemption lane (IFRNLLEI01PRD-1833, 2026-08-14): with
# ~/gateway.mutations_intersite_allow armed, this lane acts under global shadow (audited below).
...
mutation_shadow && mutation_exempt_audit intersite "action=$action tunnel=$action_tunnel peer=$action_peer (clear ipsec sa on nlrtr01)"
