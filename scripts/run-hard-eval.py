...
OLLAMA_URL = os.environ.get("OLLAMA_URL", "http://nl-gpu01:11441")
    ...
    try:
        with urllib.request.urlopen(req, timeout=45) as resp:
            ...
            try:
                ...
                import sys as _ps; _ps.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)), 'lib'))
                from pricing import cost_usd
                cost = cost_usd(JUDGE_MODEL, in_tok, out_tok)
