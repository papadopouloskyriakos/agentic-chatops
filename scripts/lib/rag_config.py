...
# Generate plane (2026-08-26 split, gpu01 VRAM-starvation RCA): every LLM
# /api/generate goes to the ollama-gen instance; :11434 stays embed-only
# estate-wide so the scheduler never evicts a busy embed runner (the Ollama
# 0.32.15 wedge). See docs/runbooks/rerank-service.md § Dynamic VRAM.
OLLAMA_GEN_URL = os.environ.get("OLLAMA_GEN_URL", "http://nl-gpu01:11441")
