...
#
# Tier 1 is RETIRED as an LLM-agent tier since 2026-04-29 (cc-cc cutover); current
# Tier 1 dispatch is deterministic shell on nl-claude01 via run-triage.sh, and
# every entry below for Tier 1 reflects historical data only.
ROLE_MAP = {
    ...
    1: {  # Tier 1 OpenClaw triage — RETIRED 2026-04-29 with cc-cc cutover.
        ...
        "claude-sonnet-4-6": "Tier 1 OpenClaw Triage (active 2026-04-29 morning, retired evening with cc-cc cutover)",
        "claude-opus-4-7": "Tier 1 OpenClaw Fallback (retired 2026-04-29 with cc-cc cutover)",
        "claude-opus-4-6": "Tier 1 OpenClaw Fallback (retired 2026-04-29 with cc-cc cutover)",
        ...
        "claude-haiku-4-5": "Tier 1 OpenClaw Fallback (retired 2026-04-29 with cc-cc cutover)",
        "devstral": "Tier 1 OpenClaw Local Fallback (retired 2026-04-29 with cc-cc cutover)",
    },
    2: {  # Tier 2 — Claude Code deep investigation (current production)
        "claude-haiku-4-5": "Synthesis + LLM Judge",
        ...
        "devstral": "Tier 2 Local Fallback (Claude Code, rare)",
    },
}
NAME_MAP = {
...
for tier, model, reqs, tokens in db.execute(
    ...
    models[(tier, model)] = {"tier": tier, "requests": reqs, "tokens": tokens or 0, "sessions": 0}
