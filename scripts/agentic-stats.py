...
# Order-sensitive: more specific patterns first (substring match). Claude + GPT
# tiers come last so the reranker/rewriter/embedder matches grab their rows before
# the "claude-" catchalls.
ROLE_MAP = {
    # Local Tier 0 — RAG pipeline components
    ...
    # Tier 1 — OpenClaw triage
    "gpt-5.1": "Tier 1 Triage (OpenClaw)",
    "gpt-4o-mini": "Tier 1 Triage Fallback",
    "gpt-4o": "Tier 1 Triage (legacy, migrated to GPT-5.1)",
    "devstral": "Tier 1 Fallback (OpenClaw local)",
    # Tier 2 — Claude Code deep investigation
    "claude-haiku-4-5": "Synthesis + LLM Judge",
    "claude-opus-4-7": "Tier 2 Investigation (Claude Code)",
    "claude-opus-4-6": "Tier 2 Investigation (legacy, migrated to Opus 4.7)",
    "claude-sonnet-4-6": "Tier 2 Investigation (Sonnet)",
}
NAME_MAP = {
