...
# The four MeshSat software repos moved to products/meshsat on 2026-09-17 (MESHSAT-1214);
# the old products/cubeos/meshsat* clones on the sync host are stale leftovers, not synced.
declare -A REPOS=(
  ...
  ["products/meshsat/meshsat"]="products/meshsat/meshsat"
  ["products/meshsat/meshsat-android"]="products/meshsat/meshsat-android"
  ["products/meshsat/meshsat-hub"]="products/meshsat/meshsat-hub"
  ["products/meshsat/meshsat-website"]="products/meshsat/meshsat-website"
