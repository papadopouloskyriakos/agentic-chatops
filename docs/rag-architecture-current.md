...
Auto-generated by `scripts/refresh-rag-architecture.py` on 2026-07-03 04:02 UTC.
Row counts and weights are introspected from the live system; prose is templated.

## Headline numbers (live)

- **Hard retrieval judge hit@5**: 0.000 (weekly cron) 
- **Hard KG traversal judge coverage@5**: 0.000
- **RAGAS golden-set** (n=176): faithfulness 0.94, precision 0.88, recall 0.90, answer_relevance 0.68
- **End-to-end latency**: p50 9.56s, p95 15.87s (5-min rolling probe)
- **Total embedded vectors**: 25705 across embedded tables

### Corpus by table — exact row counts

**Embedded tables and row counts:** incident_knowledge (1887), wiki_articles (3353), session_transcripts (20395), chaos_experiments (70). Graph: graph_entities (721) and graph_relationships (661).

| Table | Embedded rows |
|---|---|
| `incident_knowledge` | 1887 |
| `wiki_articles` | 3353 |
| `session_transcripts` | 20395 |
| `chaos_experiments` | 70 |
| Graph entities / relationships | 721 / 661 |
...
Last regenerated: 2026-07-03 04:02 UTC
