...
**Detection method:** Separate SSH session to NL ASA runs `show bgp neighbors 10.255.200.X | include BGP state`. If the xs4all VTI BGP peer is Active/Idle (not Established), all 3 xs4all tunnels are marked `standby`.
