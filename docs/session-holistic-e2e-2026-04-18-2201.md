# Session Holistic E2E Report — 2026-04-18-2201

Runtime: 181s. Total tests: 23. Skipped: 0.
...
| T1 | retrieval | rerank /rerank returns scores | **FAIL** | none | {"ranked": [{"index": 0, "score": 0.024788880720734596}], "latency_ms": 78, "model": "BAAI/bge-reranker-v2-m3"} | 597 |
| T2 | retrieval | RAG Fusion ≥3 variants | **PASS** | D-rated (single-query) | 4-variants | 598 |
| T3 | retrieval | LCR edge-first middle-last | **FAIL** | F-rated (no reorder) | invariant-broken | 599 |
...
| T14 | data | 3 nl-pve01 incidents backfilled + embedded | **PASS** | 0 rows | 3/3 | 615 |
...
| T10 | quality | hard-eval 7q judge_hit@5 | **WARN** | 0.571 (4/7) | 0.714 | 609 |
