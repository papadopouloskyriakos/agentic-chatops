...
| Model | Provider | API | Version | Use Case |
|-------|----------|-----|---------|----------|
| gpt-5.1 | OpenAI | api.openai.com/v1/chat/completions | GPT-5.1 (migrated from GPT-4o 2026-04-07) | Primary triage and investigation |
| gpt-4o-mini | OpenAI | api.openai.com/v1/chat/completions | GPT-4o-mini | Fallback for cost optimization |

**Authentication:** OPENAI_API_KEY in .env (service account key)
**Data handling:** API usage, not training per OpenAI Business terms
...
| OpenAI API | High | TLS cert chain, API key auth, commercial terms |
...
| Credential compromise | ANTHROPIC_API_KEY and OPENAI_API_KEY tracked in credential_usage_log with 90-day rotation | Tracked |
