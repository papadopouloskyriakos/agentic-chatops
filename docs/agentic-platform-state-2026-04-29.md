...
| 8 | Caching & retrieval (RAG) | A+ | 5-signal RRF: semantic + keyword + wiki + 0.3·transcript + 0.25·chaos_baselines; cross-encoder rerank (bge-reranker-v2-m3 on nl-gpu01:11436); RAG-quality gate; HyDE; 4 named circuit breakers |
