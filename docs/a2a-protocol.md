...
- **Tier 1 (OpenClaw/claude-sonnet-4-6):** L1/L2 triage, quick diagnostics, reviews
...
```json
{
  ...
  "payload": {
    ...
    "partialFindings": "Device is LXC on nl-pve03, LibreNMS shows status=down",
    "suggestedAction": "Check if nl-pve03 itself is down via Proxmox MCP"
  }
}
```
