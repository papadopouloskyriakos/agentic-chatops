---
name: LibreNMS cororings threshold + nlpve04 onboarding 2026-05-10
description: Bumped 5 cororings services from --rings 5 to 6 on NL+GR LibreNMS after nlpve04 onboarding. Also added nlpve04 itself as NL device 155 + cororings svc 40. snmpd-clone trap caught mid-flight.
type: project
...
2. **Add nlpve04 as NL LibreNMS device** + cororings service for symmetry with nl-pve01/02/03 (3 NL vantage points → 4). User explicitly approved.
...
- **NL nlpve04 device:** device_id=155, mgmt IP 10.0.181.X/24, corosync ring0 10.0.X.X/29, NFS .88.28
...
- **None blocking.** nlpve04 is now fully integrated into the NL+GR cluster monitoring posture.
