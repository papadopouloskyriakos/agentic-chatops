...
- **First live evals (n=2, same night):** natural k8s-node03 pred — 9 mined-edge (0.55)
...
- **First rule approved: IFRNLLEI01PRD-1046** (nlpve04: hosts k8s-ctrl01+n8n01,
  ...
  out-of-scope gpu01 → escalates, old manual -894 confirmed closed/inert.
  **Deactivate = close issue -1046.** The live PVE seeder correctly placed
  n8n01/k8s-ctrl01 on pve04 — the hand-declared doc still says pve01 (stale; live wins).
...
- Cosmetic: update `docs/host-blast-radius.md` n8n01 placement pve01→pve04.
