...
3. **Queue drain used wrong working directory** — claude -r called without cd to project dir, session not found. Fixed: added cd /home/claude-runner/gitlab/products/cubeos && before claude invocation. (3f40aee)
