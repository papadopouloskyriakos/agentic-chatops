...
**Arming.** GATED behind the sentinel `~/gateway.platform_controller_armed` — `rm` to disarm instantly, no n8n edit. Two PrometheusRules cover it: `PlatformControllerEscalation` (a heal hit CrashLoopBackOff) and `PlatformControllerStale` (the controller itself stopped), both critical (Matrix/YT; not tier-1 since 2026-08-01/-25).
