...
SEARCH_SCRIPT="/home/claude-runner/gitlab/n8n/claude-gateway/scripts/kb-semantic-search.py"

# Semantic search via SSH to claude-runner (where the DB + script live)
