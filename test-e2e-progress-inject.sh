...
send_message() {
    ...
    python3 -c "
REDACTED_a7b84d63quests, json, sys
...
" 2>/dev/null)
    ...
    local fallback
    fallback=$(python3 -c "
REDACTED_a7b84d63quests, json, urllib.parse
room = '$room'
...
# Sanity checks
if ! python3 -c "REDACTED_a7b84d63quests" 2>/dev/null; then
