// Allow env override so the same specs can run against a local Hugo build
// (e.g. python3 -m http.server inside /tmp/kyriakos-build) as well as the
// deployed CDN. Useful for pre-deploy regression sweeps.
const STATUS_URL = process.env.STATUS_URL || 'https://kyriakos.papadopoulos.tech/status/';
