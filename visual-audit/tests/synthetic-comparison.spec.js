...
test('YouTrack BEFORE — CrowdSec issue', async ({ page }) => {
  const html = renderIssuePage({
    ...
    summary: 'CrowdSec: ssh-bf from 203.0.113.42 on nl-dmz01',
    ...
    comments: [{
      ...
      text: 'CrowdSec alert re-fired: ssh-bf from 203.0.113.42 on nl-dmz01 at 2026-04-07T15:32:15.000Z (count: 3, flap #2)',
    }],
  });
  await page.setContent(html, { waitUntil: 'load' });
  await page.waitForTimeout(500);
