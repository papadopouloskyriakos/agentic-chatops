...
- | nlcl01iot01 | 666 | pve01 | 10.0.181.X, 10.0.X.X | QEMU VM. 2C/2S, 4GB RAM, 64GB SSD. Currently online (standby failover target). |
- ssh -i ~/.ssh/one_key root@nlcl01iot01
- | nlcl01iot01 | pacemaker/crm-config.txt, corosync/corosync.conf, scripts/{hard_reset_tubeszb_olimex.sh, pacemaker_update.sh, clear_arp_nfs.sh}, systemd/pacemaker-auto-online.service, crontab-root, mnt-iot/{esphome, homeassistant, mosquitto, nodered, zigbee2mqtt} configs |
