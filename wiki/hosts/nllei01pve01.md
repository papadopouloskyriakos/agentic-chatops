...
- ssh nl-pve01 "pct exec VMID_REDACTED -- curl -s http://127.0.0.1:8404/stats\;csv" | grep redis
...
- | nl-pve01 | Intel X710 dual-port | i40e | enp110s0 (Te1/1/3) + enp1s0f1 (Te1/1/4) | bond0 → sw01 Po7 (LACP 802.3ad) | 2x10G |
