...
- | Home Assistant | `ghcr.io/home-assistant/home-assistant:stable` | 2026.3.2 | `/mnt/iot/homeassistant/ha_config:/config`, `/mnt/iot/homeassistant/ha_nl-nas01:/media/usb`, `/etc/localtime:/etc/localtime:ro`, `/run/dbus:/run/dbus:ro`, `/var/run/docker.sock:/var/run/docker.sock` | 80 (emulated hue), 8123 |
