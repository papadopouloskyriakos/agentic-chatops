...
- Canonical relay-chain documentation lives in `docker/nlprotonmail-bridge01/protonmail-bridge/CLAUDE.md` (sections "Outbound SMTP Relay Chain" and "Known Issues"). Do not duplicate that here — cite it.
- - `docker/nlprotonmail-bridge01/protonmail-bridge/CLAUDE.md` — full Bridge-to-internet mail-flow doc, troubleshooting, queue commands
