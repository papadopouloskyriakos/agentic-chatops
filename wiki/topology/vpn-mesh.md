...
> Compiled from 16 memory files + 15 CLAUDE.md files. 2026-05-06 00:48 UTC.
...
- GR RRs (frr01+frr02): `neighbor 10.255.200.X` and `neighbor 10.255.200.X` replacing loopback peers
...
- nlk8s-frr01 (NL RR, 10.0.X.X, cluster-id 1.1.1.1, pve01 CT VMID_REDACTED)
- nlk8s-frr02 (NL RR, 10.0.X.X, cluster-id 1.1.1.1, pve03 CT VMID_REDACTED)
- grk8s-frr01 (GR RR, 10.0.X.X, cluster-id 2.2.2.2, pve01 CT 201580201)
- grk8s-frr02 (GR RR, 10.0.X.X, cluster-id 2.2.2.2, pve02 CT 202580201)
