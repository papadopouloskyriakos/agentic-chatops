...
> OOB access, ASA SSH, PiKVM, maintenance companion. Compiled 2026-07-03 04:30 UTC.
...
**nl-nas02 (DS1513+) — CANNOT upgrade to DSM 7.2.** Hardware-locked to DSM 7.1.x (Atom D2700, no AES-NI). Synology dropped 7.2 support. Playbook comments fixed, default target changed to `nl-nas01` only. Disk 5 (sde) has 56 bad sectors. Extended Life Phase through 2026. Plan DS1523+ replacement.
