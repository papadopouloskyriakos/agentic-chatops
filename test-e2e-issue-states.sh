...
MODE_FILE="/home/claude-runner/gateway.mode"
SYNC_SCRIPT="/home/claude-runner/scripts/sync-mode-openclaw.sh"
...
run_preflight() {
    ...
    local n8n_key
    n8n_key=$(python3 -c "import json; cfg=json.load(open('/home/claude-runner/.claude.json')); print(cfg['mcpServers']['n8n-mcp']['env']['N8N_API_KEY'])")
    local active
...
test_15_meshsat_room_routing() {
    ...
    sqlite3 /home/claude-runner/gitlab/products/cubeos/claude-context/gateway.db \
        "DELETE FROM sessions WHERE issue_id='$MESHSAT_TEST_ISSUE'" 2>/dev/null
    rm -f "/home/claude-runner/gitlab/products/cubeos/claude-context/gateway.cooldown.$MESHSAT_TEST_ISSUE" 2>/dev/null
    ...
    sqlite3 /home/claude-runner/gitlab/products/cubeos/claude-context/gateway.db \
        "DELETE FROM sessions WHERE issue_id='$MESHSAT_TEST_ISSUE'" 2>/dev/null
    rm -f /home/claude-runner/gitlab/products/cubeos/claude-context/gateway.lock 2>/dev/null
    touch "/home/claude-runner/gitlab/products/cubeos/claude-context/gateway.cooldown.$MESHSAT_TEST_ISSUE"
    sleep 35  # cooldown
}
